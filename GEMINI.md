...
An agent designed to review documentation files for clarity, correctness, and consistency.
It evaluates writing style, checks reference links, and ensures the text is free from spelling and grammatical errors.
